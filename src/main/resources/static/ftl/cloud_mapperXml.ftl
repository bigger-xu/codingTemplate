...
<mapper namespace="${package}.dao.${objectName}Mapper" >
    ...
    <resultMap id="${objectName}VoResultMap" type="${package}.entity.vo.response.${objectName}Response" extends="${objectName}ResultMap">
    ...
    <select id="selectListBySearch" parameterType="${package}.entity.vo.request.${objectName}Request" resultMap="${objectName}ResultMap">
    ...
    <select id="selectPageList" parameterType="${package}.entity.vo.request.${objectName}Request" resultMap="${objectName}ResultMap">
        select <include refid="${objectName}_Column_List" /> from ${tableName} where 1=1
        <#list columnList as column>
            <#if column.objectType?exists  &&column.objectType=="String">
        ${r"<if test="}"${column.attrVariableName}!=null and ${column.attrVariableName}!=''"${r">"}
    ...
    <select id="selectPageCount" parameterType="${package}.entity.vo.request.${objectName}Request" resultType="java.lang.Integer">
